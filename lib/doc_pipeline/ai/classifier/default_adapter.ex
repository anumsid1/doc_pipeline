defmodule DocPipeline.AI.Classifier.DefaultAdapter do
  @moduledoc """
  Classifies a document by sending its raw text to the Claude API and
  parsing the returned domain type.
  """

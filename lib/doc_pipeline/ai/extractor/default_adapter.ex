defmodule DocPipeline.AI.Extractor.DefaultAdapter do
  @moduledoc """
  Extracts structured fields and line items by sending a domain-specific
  prompt and the document's raw text to the Claude API, then parsing
  the JSON response.
  """

  @behaviour DocPipeline.AI.Extractor
  ...
  defp api_key, do: Application.get_env(:doc_pipeline, :anthropic_api_key)
end

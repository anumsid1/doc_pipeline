defmodule DocPipeline.AI.Extractor.MockAdapter do
  @moduledoc """
  Test-only extractor adapter returning canned fields/line items per
  domain type instead of calling the Claude API.
  """

# test/doc_pipeline/documents_test.exs
defmodule DocPipeline.DocumentsTest do
  ...
  describe "get_documents_by_type/2" do
    test "filters by domain type", %{project: project} do
      ...
      invoices = Documents.get_document_by_type(project.id, "invoice")
